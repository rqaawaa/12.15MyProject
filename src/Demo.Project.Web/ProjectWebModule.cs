...
using Demo.Project.MultiTenancy;
using Demo.Project.Web.Menus;
    ...
    public class ProjectWebModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Demo.Project.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Demo.Project.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Demo.Project.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ProjectApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Demo.Project.Application"));
